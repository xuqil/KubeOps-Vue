      ...
      <el-form
        ...
        <el-card>
          ...
          <el-form-item label="任务函数" prop="task">
            <el-select v-model="taskForm.task" clearable filterable placeholder="请选择任务函数">
              <el-option
        ...
        <el-card>
          ...
          <el-form-item label="时间间隔" prop="interval">
            <el-select v-model="taskForm.interval" clearable filterable placeholder="请选择时间间隔">
              <el-option
          ...
          <el-form-item label="定时器" prop="crontab">
            <el-select v-model="taskForm.crontab" clearable filterable placeholder="请选择定时器">
              <el-option
          ...
          <el-form-item label="计时" prop="clocked">
            <el-select v-model="taskForm.clocked" clearable filterable placeholder="请选择关闭时间">
              <el-option
