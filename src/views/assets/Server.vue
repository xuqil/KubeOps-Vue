  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="serversList" @sort-change="sortChange" :header-cell-style="getTableHeaderStyle">
        ...
        <el-table-column label="IP" prop="ip" align="center" min-width="150px" sortable="custom"></el-table-column>
        ...
        <el-table-column label="创建日期" prop="c_time" align="center" min-width="180px" sortable="custom">
          <template slot-scope="scope">{{scope.row.c_time | dataFormat }}</template>
        </el-table-column>
        <el-table-column label="更新日期" prop="u_time" align="center" min-width="180px" sortable="custom">
